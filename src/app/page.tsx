        ...
        <div className="flex w-full h-screen relative items-center justify-center pt-[162px]">
          ...
          <div className="flex flex-col z-10 lg:w-[50%] sm:w-[75%] w-[90%] gap-6 items-center justify-center text-center text-white">
            ...
            <h3 className="!font-medium">
              Oferujemy zajęcia nauki pływania w kameralnych grupach oraz w
              formie lekcji indywidualnych i dwuosobowych. Pierwsze zajęcia
              grupowe są darmowe.
            </h3>
            <ButtonNavRounded
              href="/nauka-plywania#grupy"
              label="Sprawdź podział naszych grup"
            />
          ...
          <div className="flex flex-col w-full py-[100px] lg-px-0 px-4 items-center md:gap-[100px] gap-[50px] z-10">
            ...
            <div className="flex flex-col gap-8 justify-center items-center">
              <div className="flex flex-col sm:flex-row flex-wrap xl:gap-16 gap-10 justify-center">
                {GROUPS_LIST.slice(0, GROUPS_LIST.length - 2).map(
                  (group, i) => (
                    <GroupLink key={i} {...group} />
                  )
                )}
              </div>
            ...
            <div className="flex flex-row flex-wrap gap-16 justify-center">
              {GROUPS_LIST.slice(GROUPS_LIST.length - 2).map((group, i) => (
                <GroupLink key={i} {...group} />
              ))}
            </div>
            <div className="flex flex-col lg:flex-row justify-center gap-12 items-center">
              <div className="flex flex-col gap-4 xl:w-[520px] w-auto">
                <h2 className="text-center lg:text-left">
                  Witaj w Szkole Szkrab!
                </h2>
                <p className="text-center lg:text-left">
                  Szkoła Pływania Szkrab to miejsce, które powstało z pasji do
                  pływania i aktywności fizycznej oraz chęci dzielenia się
                  wiedzą i doświadczeniem z wszystkimi szkrabami chcącymi czuć
                  się w wodzie pewnie i bezpiecznie.
                </p>
                <p className="text-center lg:text-left">
                  Nazywam się Justyna Jurczyk, jestem magistrem wychowania
                  fizycznego, instruktorką sportu o specjalizacji pływanie oraz
                  instruktorką nauki pływania niemowląt. Swoją przygodę z
                  pływaniem rozpoczęłam jako 7 letnia zawodniczka lokalnego
                  klubu KS Wiking. Regularna aktywność fizyczna wdrażana od
                  najmłodszych lat rozbudziła we mnie pasję do sportu oraz chęć
                  jej dzielenia z innymi. Od ponad 6 lat prowadzę zajęcia nauki
                  pływania dla dzieci powyżej 3 roku życia, młodzieży oraz osób
                  dorosłych na każdym poziomie zaawansowania. Obecnie jestem
                  również nauczycielem pływania w Krakowskim Szkolnym Ośrodku
                  Sportu.{' '}
                </p>
                <p className="text-center lg:text-left">
                  Zapraszam Cię na organizowane przeze mnie zajęcia nauki
                  pływania na basenie w Wolbromiu!{' '}
                </p>
              </div>
              <Image
                src={JustynaImg}
                ...
                width={545}
                height={727}
                className="xl:w-[500px] h-fit lg:w-[40%] w-[90%] sm:w-[50%] object-contain rounded-[80px]"
              />
            </div>
          </div>
        </div>
