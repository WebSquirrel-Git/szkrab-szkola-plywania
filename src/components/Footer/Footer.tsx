...
<Link className='cursor-pointer text-[16px] font-medium' href='/nauka-plywania'>
            Nauka pływania
            </Link>
<Link className='cursor-pointer text-[16px] font-medium' href='/nauka-plywania#cennik'>
            Cennik
            </Link>
            <Link className='cursor-pointer text-[16px] font-medium' href='/baseny/wolbrom'>
            Basen Wolbrom
            </Link>
             <Link className='cursor-pointer text-[16px] font-medium' href='/baseny/wolbrom'>
...
<Image src={Logo} alt='Szkoła pływania Szkrab' width={189} height={228} className='h-[150px] w-auto'/>
   <div className='flex flex-col gap-4 items-center'>
    <Link className='cursor-pointer text-[16px] font-medium' href="mailto:szkola.szkrab@gmail.com">szkola.szkrab@gmail.com</Link>
   <Link className='cursor-pointer text-[16px] font-medium' href="tel:+48111222333">+48 222 333 444</Link>
