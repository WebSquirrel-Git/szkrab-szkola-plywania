  ...
  return (
    ...
    >
      ...
      <div className='flex flex-row gap-2'>
        <ButtonNavRounded href='/assets/statues/Polityka_prywatności.pdf' label='Polityka prywatności'/>
