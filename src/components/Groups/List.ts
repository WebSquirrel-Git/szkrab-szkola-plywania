...
export const GROUPS_LIST = [
    {
        ...
        age:'3-4 lata',
        icon:SzkrabyIcon,
        list:['Czas zajęć 30 minut','Wielkość grupy 4 kursantów','Zajęcia bez udziału rodziców','Instruktor jest z dziećmi w wodzie'],
        ...
        },
     {
        ...
        icon:RekinyIcon,
      list:['Wielkość grupy 6 kursantów','Zajęcia bez udziału rodzica','Czas zajęć 45 minut','Instruktor prowadzi zajęcia z brzegu'],
        description:'Zajęcia dla kursantów średniozaawansowanych, które opanowały technikę pływania stylem grzbietowym oraz stylem dowolnym (kraulem). Celem zajęć w tej grupie będzie doskonalenie opanowanych stylów pływackich oraz nauka stylu klasycznego (żabka). Ze względu na wysoki poziom zaawansowania kursantów, poszczególne zadania pływackie będą wykonywane na dłuższych dystansach z organiczemien użycia sprzętu wypornościowego. '
        },
     {
        name:'Dorośli',
        age:'18-99 lat',
        icon:DorosliIcon,
        list:['Wielkość grupy 6 kursantów','Czas zajęć 45 minut','Instruktor prowadzi zajęcia z brzegu lub z wody w zależności od potrzeb kursantów'],
    ...
    },
     {
        ...
        list:['Zajęcia instruktor + kursant','Czas trwania 45 minut','Instruktor prowadzi zajęcia z brzegu lub z wody w zależności od potrzeb kursanta'],
        ...
        },
     {
        ...
        age:'',
        icon:DwuosoboweIcon,
        list:['Instruktor + dwójka kursantów','Czas trwania 45 minut','Instruktor prowadzi zajęcia z brzegu lub z wody w zależności od potrzeb kursanta'],
        description:'Zajęcia, na których instruktor jest do całkowitej dyspozycji dwóch kursantów. Ta forma zajęć, podobnie jak w przypadku lekcji indywidualnej sprawdzi się szczególnie w przypadku osób, ceniących sobie kameralne warunki pracy. :) Zajęcia w tej formie dadzą najlepsze efekty, jeśli uczestnicy zajęć są w podobnym wieku i posiadają podobne umiejętności pływackie.'
        },
]