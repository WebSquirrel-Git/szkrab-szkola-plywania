...
const schema = z.object({
  ...
  age: z
    .number()
    .min(3, 'Minimalny wiek uczestnika to 3 lata')
    .max(99, 'Maksymalny wiek uczestnika to 99 lat'),
});
      ...
      <div className=" flex flex-col lg:flex-row justify-center w-full lg:gap-6 gap-0 items-center">
        ...
        <div className="flex flex-col xl:pr-[50px] xl:w-[40%] sm:w-[400px] w-[80%]">
          ...
          <div className="w-full h-10 flex flex-row items-center justify-center border-1 border-mint rounded-full  gap-3 px-2.5">
            <select
              {...register('lessonType')}
              className="w-full border-0 outline-none size-4 placeholder-[#B0B0B0] h-full"
            >
